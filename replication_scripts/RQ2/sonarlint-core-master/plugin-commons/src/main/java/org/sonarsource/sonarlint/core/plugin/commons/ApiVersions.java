...
public class ApiVersions {
  ...
  public static Version loadSonarLintPluginApiVersion() {
	  try {
		  URL url = new URL("jar:file:/home/carloseduardo/.m2/repository/org/sonarsource/sonarlint/core/sonarlint-core/8.14.0.63103/sonarlint-core-8.14.0.63103.jar!/sonarlint-api-version.txt");
		  return loadVersion(url,"sonarlint-api-version.txt");
	  } catch(Exception e) {
